...
class Settings(BaseSettings):
    ...
    # Accepts comma-separated or JSON array formats (see allowed_origins property).
    ALLOWED_ORIGINS: str = "http://localhost:3000"

    @property
    def allowed_origins(self) -> List[str]:
        """Parse ALLOWED_ORIGINS from either comma-separated or JSON-array format."""
    ...
    SMTP_USER: str = ""
    SMTP_PASSWORD: str = ""
    SMTP_FROM_EMAIL: str = "noreply@visiondx.app"
    SMTP_FROM_NAME: str = "VisionDx"
