...
from app.core.exceptions import ImageValidationError, InferenceError, NotFoundError  # noqa: F401 (ImageValidationError re-raised from engine)
...
class PredictionService:
    ...
    async def create_and_predict(
        ...
        from app.services.image_service import validate_and_strip_exif, validate_blood_smear

        # Reject non-blood-smear images before any DB write
        validate_blood_smear(file_data)
        ...
        except (InferenceError, ImageValidationError) as exc:
